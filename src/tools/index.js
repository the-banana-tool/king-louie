...
const BrowserSessionTool = require('./builtin/browser-session-tool');
const BrowserPageTool = require('./builtin/browser-page-tool');
const BrowserExtractTool = require('./builtin/browser-extract-tool');
...
function initializeTools() {
  ...
  toolRegistry.register(BrowserSessionTool);
  toolRegistry.register(BrowserPageTool);
